...
# SVL
kruskal.test(SVL ~ SPECIES, data = SVL)
boxplot(SVL ~ SPECIES, data = SVL, xlab = "Species", ylab = "SVL (mm)")
dunnTest(SVL ~ SPECIES, data = SVL)

# prey volume consumed ~ species

kruskal.test(VOLUME ~ SPECIES, data = totalvol_aquatic)

kruskal.test(VOLUME ~ SPECIES, data = totalvol_int)

kruskal.test(VOLUME ~ SPECIES, data = totalvol_terr)

kruskal.test(VOLUME ~ SPECIES, data = totalvol_neither)
...
dunnTest(VOLUME ~ SPECIES, data = totalvol_aquatic)
dunnTest(VOLUME ~ SPECIES, data = totalvol_int)
dunnTest(VOLUME ~ SPECIES, data = totalvol_terr)


# dot plots of prey category volumes

ggplot(totalvol_aquatic, aes(x = SPECIES, y = VOLUME)) + geom_jitter(width = 0.01, size = 8, alpha = 0.1,) + ggtitle("Aquatic Prey Volume")

ggplot(totalvol_int, aes(x = SPECIES, y = VOLUME)) + geom_jitter(width = 0.01, size = 8, alpha = 0.1,) + ggtitle("Intermediate Prey Volume")

ggplot(totalvol_terr, aes(x = SPECIES, y = VOLUME)) + geom_jitter(width = 0.01, size = 8, alpha = 0.1,) + ggtitle("Terrestrial Prey Volume")
