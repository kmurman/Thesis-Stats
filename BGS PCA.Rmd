...
backsamps <- read.csv("C:\\Users\\kmurm\\Documents\\GitHub\\Thesis Stats\\Thesis Stats\\Data\\Cleaned\\BGS SITE MATRIX.csv")

agebacksamps <- read.csv("C:\\Users\\kmurm\\Documents\\GitHub\\Thesis Stats\\Thesis Stats\\Data\\Cleaned\\BGS SITE MATRIX v2.csv")
...
fviz_pca_var(backsamps.pca, col.var = "contrib",
             ...
             select.ind = list(contrib = 10), repel = TRUE) ##avoid text overlapping
