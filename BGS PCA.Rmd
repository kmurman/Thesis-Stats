...
fviz_pca_biplot(bgsxsals.pca, label = "var", select.var = list(contrib = 10),
                habillage = as.factor(bgsxsals2$samp.type1), addEllipses = TRUE, repel = TRUE, palette =
...
anosim(x = bgsxsals_com, grouping = bgsxsals_nozero$samp.type2, permutations = 9999, distance = "bray")
